...
NEXLEDGER_HOME=${NEXLEDGER_HOME:-${HOME:-/home/gdsecurity}/install/nexledger}
HYPER_NETWORK_HOME=${HYPER_NETWORK_HOME:-${NEXLEDGER_HOME}/network}
GD_TOOL_WAS_HOME=${GD_TOOL_WAS_HOME:-${NEXLEDGER_HOME}/was}
